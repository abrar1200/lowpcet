    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diet_type', models.CharField(choices=[('Vegan', 'Vegan'), ('Vegetarian', 'Vegetarian'), ('Non-Vegetarian', 'Non-Vegetarian')], max_length=15)),
            ],
        ),
        migrations.CreateModel(
            name='Ingredient',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dietary_preference', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='core.dietarypreference')),
            ],
            options={
                'verbose_name': 'user',
